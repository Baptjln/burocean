        	...
        	<div class="row">
            	<div class="col col-md-9 hidden-xs">
                    ...
                    <?php
                        ...
                        foreach ($cats as $cat) {
                            echo '<div class="col col-md-4 col-xs-12">';
                            $cat_id= $cat->term_id;
                            echo "<h3>".$cat->name."</h3>";
            	...
            	<div class="col col-md-3 col-xs-12 contact">
                	<div class="logo">
